...
class MoceanSMS_carts {
     ...
     function sendSMS($from, $to, $message, $message_type = null, $dlr_url = null, $udh = null) 
     {
         ...
         $params = array(
                 ...
                 'mocean-udh' => $udh,
                 'mocean-medium' => 'wordpress_abandoned_carts'
         );
     ...
     private function invokeApi ($command, $params = array()) 
     {
         ...
         // Build the post data
         $params = array_merge($params, array('mocean-api-key' => $this->api_key, 'mocean-api-secret' => $this->api_secret, 'mocean-resp-format' => $this->response_format, 'mocean-medium' => 'wordpress_sms'));
